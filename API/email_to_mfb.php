    ...
    <tr>
        <td class="container">
            ...
            <table>
                ...
                <tr>
                    <td class="content">
                        <p>Dear '.$logged_for_name.',</p>
						 <p>Your request have been logged with ticket ID '.$issue_id.'</p>
						 <p>Details of your ticket are:</b></p>
						...
						<p>Client Name <b>'.$logged_for_name.'</b></p>
						
						<p>Kindly reply to this email with same ticket id for updates</p>
