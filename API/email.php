        ...
        <td class="container">
            ...
            <table>
                ...
                <tr>
                    <td class="content">
                        <p>Dear '.$username1.',</p>
						 <p>The Issue logged with the above Ticket ID on INLAKS SUPPORT is acknowledged:</p>
						 <p>Your Request has been forwarded to the appropriate unit with the following details:</b></p>
