							...
							<div class="card-body pb-0">
								<div class="settings-menu">
									<ul class="nav">
										...
										<li>
											<a href="financialsettings">
												<i class="ti ti-moneybag"></i> Financial Settings
											</a>
										</li>
										<li>
											<a href="leadcompanysettings" class="active">
									...
									<div class="card-body">
											...
											<h4>App Settings</h4>
											 ...
											 <li class="nav-item">
												   <a class="nav-link active" data-bs-toggle="tab" role="tab"
													   aria-current="page" href="#company-vertical-custom"
													   aria-selected="true">
													   <p class="mb-1"><i class="feather-home"></i></p>
													   <p class="mb-0 text-break">Company Setting</p>
												   </a>
											   </li>
											   ...
											   <li class="nav-item">
												   <a class="nav-link" data-bs-toggle="tab" role="tab"
													   ...
													   aria-selected="true">
													   <p class="mb-1"><i class="feather-home"></i></p>
													   <p class="mb-0 text-break">Invoice Settings</p>
												   </a>
											   </li>
											   <li class="nav-item">
												   <a class="nav-link" data-bs-toggle="tab" role="tab"
													   ...
													   <p class="mb-0 text-break">Printer</p></a>
											   </li>
											   <li class="nav-item">
												   <a class="nav-link mb-0" data-bs-toggle="tab" role="tab"
													   ...
													   <p class="mb-0 text-break">Custom Fields</p>
												   </a>
											   </li>
										...
										<li class="nav-item">
												   <a class="nav-link mb-0" data-bs-toggle="tab" role="tab"
													   ...
													   aria-selected="true">
													   <p class="mb-1"><i class="feather-headphones"></i></p>
													   <p class="mb-0 text-break">Prefixes</p>
												   </a>
											   </li>											  
											   ...
											   <li class="nav-item">
												   <a class="nav-link mb-0" data-bs-toggle="tab" role="tab"
													   ...
													   aria-selected="true">
													   <p class="mb-1"><i class="feather-headphones"></i></p>
													   <p class="mb-0 text-break">Currency</p>
												   </a>
											   </li>											  
...
<div class="tab-pane show active text-muted" id="company-vertical-custom" role="tabpanel">
 
 
 <?php include("pages/companysettingforms.php")  ?>
...
<div class="tab-pane show text-muted" id="home-vertical-custom" role="tabpanel">
 
 
 <?php include("pages/invoicesettingforms.php")  ?>
