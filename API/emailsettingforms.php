							...
							<div class="card-body pb-0">
								<div class="settings-menu">
									<ul class="nav">
										...
										<li>
											<a href="emailsettings" class="active">
											 ...
											 <ul class="nav nav-tabs flex-column vertical-tabs-2" role="tablist">
											   <li class="nav-item">
												   <a class="nav-link active" data-bs-toggle="tab" role="tab"
													   ...
													   <p class="mb-0 text-break">Email Settings</p>
												   </a>
											   </li>
											   <li class="nav-item">
												   <a class="nav-link" data-bs-toggle="tab" role="tab"
													   ...
													   <p class="mb-0 text-break">SMS Gateways</p></a>
											   </li>
											  <li class="nav-item">
												   <a class="nav-link mb-0" data-bs-toggle="tab" role="tab"
													   ...
													   <p class="mb-0 text-break">Core Banking Integration</p>
												   </a>
											   </li>
...
<div class="tab-pane show active text-muted" id="home-vertical-custom" role="tabpanel">
 ...
 <?php include("pages/systememailform.php")  ?>
...
<?php include("pages/systemsmsgatewayform.php")  ?>
...
<?php include("pages/corbankingintergrationform.php")  ?> 
