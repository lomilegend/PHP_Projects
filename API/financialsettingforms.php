							...
							<div class="card-body pb-0">
								<div class="settings-menu">
									<ul class="nav">
										...
										<li>
											<a href="financialsettings" class="active">
											 ...
											 <ul class="nav nav-tabs flex-column vertical-tabs-2" role="tablist">
											   <li class="nav-item">
												   <a class="nav-link active" data-bs-toggle="tab" role="tab"
													   ...
													   <p class="mb-0 text-break">Bank Accounts</p>
												   </a>
											   </li>
											   <li class="nav-item">
												   <a class="nav-link" data-bs-toggle="tab" role="tab"
													   ...
													   <p class="mb-0 text-break">Tax Rates</p></a>
											   </li>
											<li class="nav-item">
												   <a class="nav-link mb-0" data-bs-toggle="tab" role="tab"
													   ...
													   <p class="mb-0 text-break">Currencies</p>
												   </a>
											   </li>
...
<div class="tab-pane show active text-muted" id="home-vertical-custom" role="tabpanel">
 ...
 <?php include("pages/addbankaccountsform.php")  ?>
...
<?php include("pages/addtaxratesform.php")  ?>
...
<?php include("pages/addcurrenciesform.php")  ?> 
