<div class="card main-card">
										...
										<ul>
														...
														<div class="filter-set-view">
															...
															<div class="filter-reset-btns">
																<div class="row">
																	...
																	<div class="col-6">
																		<a href="companies.html" class="btn btn-primary">Filter</a>
																	</div>
																</div>
															</div>
														</div>
											...
											<li>
												<div class="view-icons">
													<a href="companies.html" class="active"><i class="ti ti-list-tree"></i></a>
													<a href="companies-grid.html"><i class="ti ti-grid-dots"></i></a>
												</div>
											</li>
										</ul>
									</div>
						...
						<?php  include("modals/companymodals.php"); ?>
