	...
	<body>
		<div class="wrapper">
			...
			<h3><?php echo $gentlemen[2]["first_name"]; ?> from <?php echo $gentlemen[2]["country"]; ?></h3>
				<p><strong><?php echo $gentlemen[2]["first_name"]; ?></strong> is quite the <strong><?php echo $age_group[2]; ?></strong>! He sports a solid <strong><?php echo $handlebar['name']; ?></strong> Moustache that is <strong><?php echo $handlebar['colour']; ?></strong> in colour.</p>
